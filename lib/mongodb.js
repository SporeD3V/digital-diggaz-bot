 ...
 * Loads from MongoDB and returns structured config objects for Facebook and Spotify.
 * 
 * @param {string} [projectId='default'] - Project identifier
 * @returns {Promise<{ facebook: Object, spotify: Object }>} Config objects
 * @throws {Error} If no configuration is found in database
 * 
 * @example
 * const config = await getActiveConfig();
 * // config.facebook.groupId, config.facebook.accessToken
