/**
 * @fileoverview Facebook Graph API client for fetching group posts.
 * Handles pagination, rate limiting, and error recovery when scanning
 * the Digital Diggaz group for music posts.
 */
